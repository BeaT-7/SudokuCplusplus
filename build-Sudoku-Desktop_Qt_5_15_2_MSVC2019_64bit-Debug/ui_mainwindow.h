...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setStyleSheet(QString::fromUtf8("background-color: rgb(135, 167, 138);"));
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName(QString::fromUtf8("centralwidget"));
        StartGameBtn = new QPushButton(centralwidget);
        StartGameBtn->setObjectName(QString::fromUtf8("StartGameBtn"));
        StartGameBtn->setGeometry(QRect(310, 230, 171, 81));
        StartGameBtn->setStyleSheet(QString::fromUtf8("background-color: LightGray;\n"
"color: black;\n"
"font-weight: bold;\n"
"font-size: 27px;\n"
"border-radius: 15px;"));
